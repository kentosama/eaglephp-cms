<nav class="navbar" role="navigation" aria-label="main navigation">
  ...
  <div id="navbarBasicExample" class="navbar-menu">
    <div class="navbar-start">
      <?php $links = [
        ['label' => 'Articles', 'url' => ['controller' => 'articles', 'action' => 'index'], 'children' => [
          ['label' => 'Liste des articles', 'url' => ['controller' => 'articles', 'action' => 'index']],
          ['label' => 'Ajouter un article', 'url' => ['controller' => 'articles', 'action' => 'add']],
          ['label' => 'Types d’articles', 'divider' => true, 'url' => ['controller' => 'article_types', 'action' => 'index']],
        ]],
        ['label' => 'Games', 'url' => ['controller' => 'games', 'action' => 'index'], 'children' => [
          ['label' => 'Liste des jeux', 'url' => ['controller' => 'Games', 'action' => 'index']],
          ['label' => 'Ajouter', 'url' => ['controller' => 'games', 'action' => 'add']],
          ['label' => 'Companies', 'divider' => true, 'url' => ['controller' => 'companies', 'action' => 'index']],
          ['label' => 'Systèmes', 'url' => ['controller' => 'systems', 'action' => 'index']],
          ['label' => 'Genres', 'url' => ['controller' => 'genres', 'action' => 'index']],
        ]],
        ['label' => 'Categories', 'url' => ['controller' => 'categories', 'action' => 'index']],
        ['label' => 'Tags', 'url' => ['controller' => 'tags', 'action' => 'index']],
      
        ['label' => 'Images', 'url' => ['controller' => 'images', 'action' => 'index']],
        ['label' => 'Users', 'url' => ['controller' => 'users', 'action' => 'index']],
        ['label' => 'Options', 'url' => ['controller' => 'options', 'action' => 'index']],
      ] ?>

      <?php foreach ($links as $link): ?>
        <?php if (isset($link['children'])): ?>
          <div class="navbar-item has-dropdown is-hoverable">
            <?= $this->html->link($link['label'], $link['url'], ['class' => 'navbar-link']) ?>
            <div class="navbar-dropdown is-boxed">
              <?php foreach ($link['children'] as $child): ?>
                <?php if (isset($child['divider']) && $child['divider']): ?>
                  <hr class="navbar-divider">
                <?php endif ?>
                <?= $this->html->link($child['label'], $child['url'], ['class' => 'navbar-item']) ?>
              <?php endforeach ?>
            </div>
          </div>
        <?php else: ?>
          <?= $this->html->link($link['label'], $link['url'], ['class' => 'navbar-item']) ?>
        <?php endif ?>
      <?php endforeach ?>
